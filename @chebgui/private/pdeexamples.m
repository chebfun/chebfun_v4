...
switch exampleNumber
    ...
    case 6
        ...
        b = '1';
        t = '0:.05:2';
        DE = {'-u + (x + 1)*v + 0.1*u" = u_t'; 'u - (x + 1)*v + 0.2*v" = v_t'};
        LBC = {'u'' = 0';'v'' = 0'};
        RBC = {'u'' = 0';'v'' = 0'};
        init = {'1';'1'};
        tol = '1e-6';
    ...
    case 7
        ...
        b = '1';
        t = '0:.05:2';
        DE = {'u - (x + 1)*v + 0.2*v" = v_t' ; '-u + (x + 1)*v + 0.1*u" = u_t'};
        LBC = {'u'' = 0';'v'' = 0'};
        RBC = {'u'' = 0';'v'' = 0'};
        init = {'1';'1'};
        tol = '1e-6';
    ...
    case 8
        ...
        b = '1';
        t = '0:.1:2';
        DE = {'0.1*u"-100*u*v=u_t' ; '0.2*v"-100*u*v=v_t' ; '0.001*w"+200*u*v=w_t'};
        LBC = {'neumann'};
        %         LBC = {'u'''; 'v''' ; 'w'''};
        RBC = {'neumann'};
        %         RBC = {'u'''; 'v''' ; 'w'''};
    ...
    case 12
        ...
        b = '10';
        t = '0:.1:10';
        DE = {'v=u_t','u"+exp(-100*x^2)*sin(pi*t)=v_t'};
        LBC = {'u'' = 0'; 'v'' = 0'};
        RBC = {'u'' = 0'; 'v'' = 0'};
        init = {'0','0'};
        tol = '1e-6';
