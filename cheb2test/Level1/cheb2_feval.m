function pass = cheb2_feval
% Test to check that the fun2s that we are forming are actually correct in
% terms of reasonable approximation to the given operator. 
