...
% CHEBPDE Help for the chebop BVP GUI
%
% Under construction

% CHEBPDE M-file for chebpde.fig
%      CHEBPDE, by itself, creates a new CHEBPDE or raises the existing
%      singleton*.
%
%      H = CHEBPDE returns the handle to a new CHEBPDE or the handle to
%      the existing singleton*.
%
%      CHEBPDE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CHEBPDE.M with the given input arguments.
%
%      CHEBPDE('Property','Value',...) creates a new CHEBPDE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chebpde_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chebpde_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chebpde

% Last Modified by GUIDE v2.5 13-Apr-2010 14:57:41
