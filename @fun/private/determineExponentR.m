...
function exponent = determineExponentR(OP)
...
if  path==0
    ...
    [diverge,path] = blowupR(softenR(OP,exponent),path);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% blowupR performs two consecutive tests on the input operator to %%%%%
%%%% determine whether it blows up (1) or not (0) %%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [diverge,path] = blowupR(OP,path)
...
% assume monotonic increase this close to singularity means divergence
...
function softenedFun = softenR(OP,exponent)
