...
f = chebfun('(1-x).^-0.5.*(1+x).^-0.5','blowup','on');
pass(1) = abs(sum(f)-pi) < tol;
    
f = chebfun('exp(cos(x)).*(1-x).^-0.5.*(1+x).^-0.5','blowup','on');
pass(2) =  abs(sum(f)-6.8423116016431490) < tol;

f = chebfun('exp(sin(x)).*(1-x).^-0.5.*(1+x).^-0.5','blowup','on');
pass(3) = abs(sum(f)-3.7796493041223796) < tol;
    
f = chebfun('(1-x).^-0.1.*(1+x).^-0.4','blowup','on');
