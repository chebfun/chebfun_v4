...
%%
% (Chebfun2 Example fun/Chebfun2Scribble.m)
% [Tags: #gift, #scribble, #fun]
...
% http://www2.maths.ox.ac.uk/chebfun/examples/fun/html/HelloWorld.shtml, March
% 2013.
%%
% [2] L. N. Trefethen, Writing a message in 3D, Chebfun Example, 
% http://www2.maths.ox.ac.uk/chebfun/examples/fun/html/Writing3D.shtml, Nov
% 2010.
%% 
% [3] L. N. Trefethen, Birthday cards and analytic functions, Chebfun Example, 
% http://www2.maths.ox.ac.uk/chebfun/examples/fun/html/Birthday.shtml, Sept 2010.
