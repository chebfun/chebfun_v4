...
LW = 'LineWidth'; lw = 1.6; MS = 'MarkerSize'; FS = 'FontSize'; fs = 14;
...
%%
% Finally, in order to be able to create a chebfun, we must come up with a
% parametric representation of the snowflake path.  The following function
% parametrizes the path with vertices in the column vector K by a parameter
% t that ranges over [0, 1]:
...
%% 
% How big is this chebfun?

length(z)
z.nfuns

%%
% We see that it needs 387 points to represent the snowflake curve, split
% up between 192 smooth pieces.  There is essentially one smooth piece for
% each line segment on the curve.
