%% TRANSIENT GROWTH IN THE LINEARIZED VLASOV-POISSON OPERATOR
...
%
%   K(s,t) = [a^2 (s-t)^2 - 1] exp [ -a^2 (s-t)^2/2 ]
%
...
% kernel K. In this case, the symmetry K(s,t)=K(t,s) simplifies things even
...
%%
% It's easy to show that as a->0, the numerical absicssa is T/2 on the
% domain [0,T].
numabs(0)
...
%%
% Presumably the breakpoint represents eigenvalues for two different
% eigenfunctions crossing one another. We can check this assertion by
...
% continuously with the parameter, the color scheme changes in the two
