...
% normalization of a truncated Guassian, it gets smaller near the endpoints, and
...
% are typically low stakes and for which the student could get a lot of extra
