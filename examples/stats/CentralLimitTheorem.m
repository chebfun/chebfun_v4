...
% distrubtion with mean $\mu$ and variance $\sigma^2<\infty$, and consider
...
% "B-splines and convolutions" [1].  The only difference is that in that
% case we start with a uniform rather than triangular distribution.

%%
% References
% [1] http://www.chebfun.org/examples/approx/BSplineConv.shtml
