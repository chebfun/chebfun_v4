...
% additional features to the ODE45 command in Chebfun2: 
...
% see [1]. Let's make it interesting by supposing the stairs is the 
% following piecewise chebfun: 
...
% $h(0)=2$, and is thrown horizontally at a speed of one metre per speed,

u0 = [2 0 0];  % u0 = [h(0) h'(0) x(0)]

%% 
% Further let's suppose the ball then bounces down the stairs under 
% Marsian gravity (gravity constant of 1) with a small Marsian air resistence. 
