...
% help chebfunpref.  In particular, the 'blowup' preference relates to
% chebfuns that diverge to infinity or have other singularities, described
% in Chapter 9, and the 'sampletest' preference controls whether a function
% is evaluated at an extra point as a safety check of convergence.
