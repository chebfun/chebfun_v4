...
% with Chebfun, see [Gonnet 2009].  See also "Using Chebfun as an integrator" in
% the Quadrature section of the online Chebfun Examples collection.
...
% Chebfun is behaving correctly in the sense
...
% lower the tolerance.   In Chebfun, this can be done
...
% implemented by Nick Hale.   To start with, suppose
...
% one or both endpoints, and are used internally by Chebfun
