...
%%
% (Chebfun2 example ComplexAnalysis/PhasePortraits.m)

%% Phase portraits for complex functions 
% Phase portraits are a technique for visualising complex valued functions 
% of a single complex variable. They rely on the visual encoding of complex
% numbers: if z=r*exp(1i*t) then the rainbow colours represent the
% phase of z. Red indicates an argument of 0 and the rainbow goes 
% through red, yellow, green, blue, violet as the argument increases. By 
% default, Chebfun2 produces a phase portrait when asked to plot a chebfun2
...
% portrait, then there is a real constant c such that 
...
% As illustrated copiously in [1], the power of phase portraits is most
% fully realised when they are applied to functions with poles or other
% singularities.  Unfortunately, at present Chebfun2 cannot represent such
% functions.

%% References 
% [Wegert 2012] E. Wegert, Visual Complex Functions: An Introduction with Phase
